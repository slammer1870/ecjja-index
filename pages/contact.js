  ...
  return (
    <div>
      <section className="text-gray-600 pt-12 pb-24 px-4 md:px-0 relative">
          <h1 className="mb-8 text-2xl m:text-4xl text-3xl font-medium text-gray-900">Contact Us</h1>
        <div className="container mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 md:w-1/2 bg-gray-300 overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            <iframe
              ...
              marginWidth={0}
              scrolling="no"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2385.166491056314!2d-6.148733283822683!3d53.286552579966546!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4867089cd3efbaa9%3A0xbe4bb1c38314da7b!2sEast%20Coast%20Jiu%20Jitsu%20Academy!5e0!3m2!1sen!2sie!4v1620135515409!5m2!1sen!2sie"
            ...
            <div className="bg-white relative flex flex-wrap py-6 shadow-md">
              <div className="lg:w-1/2 px-6">
                ...
                <a href="https://goo.gl/maps/74fVByAUM7cYUFzx6" className="mt-1 text-blue-500" target="_blank">
              ...
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <a href="mailto:info@ecjja.com"className="text-blue-500 leading-relaxed" target="_blank">
                  info@ecjja.com
                </a>
