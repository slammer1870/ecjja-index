      ...
      <section className="text-gray-600 pt-12 pb-24 px-4 md:px-0 relative">
        ...
        <div className="container mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 md:w-1/2 bg-gray-300 overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            ...
            <div className="bg-white relative flex flex-wrap py-6 shadow-md">
              <div className="lg:w-1/2 px-6">
                ...
                <a
                  href="https://goo.gl/maps/74fVByAUM7cYUFzx6"
                  className="mt-1 text-blue-500"
                  target="_blank"
                >
                  Mounttown Industrial Estate, Mounttown Lower, Glenageary,
                  Monkstown, Co. Dublin
                </a>
              </div>
          ...
          >
            ...
            <button
              type="submit"
              className="text-white bg-blue-400 border-0 py-2 px-6 focus:outline-none hover:bg-blue-500 text-lg"
            >
              {!message && loading && (
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 31 31.157"
                  className="w-5 h-5 animate-spin mx-auto my-1"
                >
