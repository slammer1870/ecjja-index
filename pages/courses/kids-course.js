...
const CourseProduct = () => {
  ...
  //Live Prices
  const priceOption = [
    "price_1Jtc4VL1Vq7u95DfksrI2OS0",
    "price_1Jtc4mL1Vq7u95DfAd9UCIeE",
    "price_1Jtc5CL1Vq7u95DfmbYCALRQ",
    "price_1Jtc64L1Vq7u95DfOl338iZc",
    "price_1Jtc6IL1Vq7u95DfNp6I1XWR",
    "price_1Jtc6jL1Vq7u95DfVpzLR7QV",
  ];
        ...
        <div className="mx-auto flex flex-wrap justify-around">
          ...
          <div className="lg:w-1/2 xl:w-7/12 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">
              8 Week Kids Beginners Course (8 - 11 Years)
            </h1>
            <p className="leading-relaxed mb-4">
              This course runs for 8 weeks. We have classes at 4pm every Tuesday
