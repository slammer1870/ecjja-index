      ...
      <div className="px-4 py-6 lg:py-24 mx-auto">
        <div className="mx-auto flex flex-wrap justify-around">
          ...
          <div className="lg:w-1/2 xl:w-7/12 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <p className="leading-relaxed mb-4">
              We also have the option of adding Private Lessons to your
              Beginners Package. Private lessons are a great way to accelerate
              your learning in a one on one setting. A coach will work with you
              at your own pace as you get to grips with our Beginners
              Curriculum.
            </p>
            ...
            <form onSubmit={handleSubmit}>
              <h3 className="text-gray-900 text-2xl font-medium mb-2">
                Please select your Course type below:
              </h3>
              <div className="relative mt-1 mb-4">
                <select
                  ...
                  onChange={() => setSelected(product.value)}
                >
                  <option value="" disabled hidden selected>
                    Click here to select your product
                  </option>

                  <option value={priceOption[0]}>
                    Beginners Course
                  </option>
                      ...
                      <div className="relative mt-1 mb-4">
                        ...
                        >
                          ...
                          <option value="unspecified">
                            I'm really not sure (we'll size you up at the
                            academy)
                          </option>
                        </select>
                        <span className="absolute right-0 top-0 h-full w-10 text-center text-gray-600 pointer-events-none flex items-center justify-center">
