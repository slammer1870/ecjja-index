...
const Footer = () => (
  <footer className="px-4 py-8 bg-gray-500 flex justify-between md:px-20 lg:px-40">
    <form className="flex flex-col w-1/2">
      ...
      <div className="flex">
        <input
          className="w-full rounded-l p-1 border-t mr-0 border-b border-l text-grey-400 border-white bg-gray-500 focus:bg-white lg:w-1/3"
          placeholder="Email Address"
        />
        <button className="px-4 rounded-r bg-gray-100 text-black p-2 uppercase border-white border-t border-b border-r">
          OK
        </button>
      </div>
