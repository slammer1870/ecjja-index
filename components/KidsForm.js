...
const KidsForm = () => {
  ...
  const contact = async (e) => {
    ...
    const res = await fetch("/api/kidscontact", {
      body: JSON.stringify({
    ...
    <section className="text-gray-600 body-font relative">
      <div className="container px-4 md:px-0 pb-12 mx-auto">
        ...
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          <form onSubmit={contact} className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full">
              <button
                type="submit"
                className="flex justify-center items-center w-full mx-auto text-white text-center bg-blue-400 border-0 py-2 px-8 focus:outline-none hover:bg-blue-500 text-lg"
              >
                {!message && loading && (
                  <svg
