export const TermsOfService = ({handleTos}) => {
  return (
    <div className="flex p-4 top-0 left-0 w-full h-full fixed bg-black bg-opacity-90 z-10 ">
      <button
        ...
        onClick={handleTos}
      ></button>
      <div className="w-full h-96 max-w-screen-md bg-white p-4 mx-auto my-auto z-20 relative overflow-auto">
        TERMS OF SERVICE
        <p>
          <br />
        </p>
        ...
        <p>
          This website is operated by East Coast Jiu Jitsu Academy. Throughout
          the site, the terms “we”, “us” and “our” refer to East Coast Jiu Jitsu
          Academy. East Coast Jiu Jitsu Academy offers this website, including
        ...
        <p>
          In no case shall East Coast Jiu Jitsu Academy, our directors,
        ...
        <p>
          You agree to indemnify, defend and hold harmless East Coast Jiu Jitsu
          Academy and our parent, subsidiaries, affiliates, partners, officers,
        ...
        <p>
          ...
          laws of Unit C, Mounttown Industrial Park, Mounttown Lower,
          Glenageary, L, A96 Y7RR, Ireland.
        </p>
        <p>
          <br />
        </p>
