...
const Form = () => {
  ...
  return (
    <section className="text-gray-600 body-font" id="signup">
      <div className="container px-4 py-20 mx-auto flex flex-wrap items-center md:px-0">
        ...
        <form
          onSubmit={signup}
          className="xl:w-2/6 md:w-1/2 bg-gray-100 p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0"
        >
          ...
          <button
            type="submit"
            className="text-white bg-blue-400 border-0 py-2 px-8 focus:outline-none hover:bg-blue-500 text-xl"
          >
            {!message && loading && (
              <svg
